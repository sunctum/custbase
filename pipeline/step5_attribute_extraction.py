...
MATERIAL_PATTERNS = {
    ...
    "Чугун": ["чугун", "чугунный", "чугуна", 'чугунным', 'чуг',
              "ggg40", "gg40", 'gjs400', 'gs-400', 'ggg50', 'gg50',
              "32ч24р",
              'ci/cd']
}

PRODUCT_TYPE_PATTERNS = {
    "Трехэксцентриковый": ['трехэксцентриковый','треxэксцентриковые', 'треxэксцентриковый', 'трехэксцентриковые', 'трехэкс', 'с тройным эксцентриком', 'с тройным эксцентриситетом', 'с тройным экcцентриситетом' 'с тройным смещением диска', '3х-эксц', 'triple offset', 'triple eccentric'],
    "Двухэксцентриковый": ['двухэксцентриковый', 'двухэксцентриковые', 'двухэкс', 'с двойным эксцентриком', 'с двойным эксцентриситетом', 'с двойным смещением диска', '2х-эксц', 'double offset', 'double eccentric'],
    "Безэксцентриковый": ['безэксцентриковый', 'безэкс', 'осевой', 'бабочка', 'без смещения диска', 'no offset', 'без эксцентриситета'],
    "Межфланцевый": ['межфланцевый', 'wafer', 'lug', '32ч24р'],
}
SEAL_PATTERNS = {
